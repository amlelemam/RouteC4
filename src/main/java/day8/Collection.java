...
//            System.out.println(s);
    ...
    static void listDemo()
    {
        ...
        System.out.println(items.get(2));   // 2.0
        System.out.println(items.size());    // 4
        System.out.println(items.getFirst()); // Apple
        System.out.println(items.getLast());  // true
    ...
    static void queueDemo()
    {
        ...
        System.out.println(q.peek()); // shows duplicate of head without removing it //3
        System.out.println(q.poll()); // shows first element //3
