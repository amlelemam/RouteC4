...
public class Book extends BookList implements Product {
    ...
    public void BookSearch(double price, String name, String author, int id, int creationYear) {
        ...
        if (creationYear >= 1998) {
            System.out.println("Book price is " + bookPrice() + ", name is " + bookName() +
                    ", author is " + bookAuthor() + " and id is " + bookID() + " Book creation year is " + bookCreationYear());
        }
        else
        {
            System.out.println("Books before 1998 aren't available");
        }
    }
